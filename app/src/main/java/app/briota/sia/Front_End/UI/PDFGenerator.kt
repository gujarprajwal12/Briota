...
class PDFGenerator : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bmp = BitmapFactory.decodeResource(resources, R.drawable.icon_gallery)
    ...
    fun generatePDF() {
        ...
        try {
            ...
            pdfDocument.writeTo(FileOutputStream(mypath))
            ...
            // on below line we are displaying a toast mesage as fail to generate PDF
